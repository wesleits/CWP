...
__device__ static const unsigned char md5_padding[64] =
{
 ...
 */
__device__ void md5_hmac_starts(md5_context *ctx, const unsigned char *key,
                      size_t keylen)
{
    size_t i;
 ...
 */
__device__ void md5_hmac_update(md5_context *ctx, const unsigned char *input,
                      size_t ilen)
{
    md5_update(ctx, input, ilen);
}
 ...
 */
__device__ void md5_hmac_finish(md5_context *ctx, unsigned char output[16])
{
 ...
 */
__device__ void md5_hmac_reset(md5_context *ctx)
{
    md5_starts(ctx);
    md5_update(ctx, ctx->ipad, 64);
}
 ...
 */
__device__ void md5_hmac(const unsigned char *key, size_t keylen,
